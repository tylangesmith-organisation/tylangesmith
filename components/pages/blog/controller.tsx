...
const blogsMetaData: BlogMetaData[] = [
  {
    ...
    description: 'In this blog, we\'ll explore how to host a Next.js static site on AWS. We\'ll use AWS CloudFront, Lambda@Edge, and S3 to implement a fully serverless solution. Being the awesome DevOps practitioners we are, we\'ll also leverage AWS CDK to deploy our infrastructure as code.',
