...
const Component = (props: Props) => {
  ...
  return (
    <div className="flex items-center">
      ...
      <div className={`flex items-center bg-black text-white text-sm rounded px-2 py-1 mx-2 ${popoverVisible ? 'opacity-100' : 'opacity-0 transition ease-out duration-150'}`}>
