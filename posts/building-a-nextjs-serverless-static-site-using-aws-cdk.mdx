...
<Image
  source="buildingANextjsServerlessStaticSiteUsingAwsCdk/header1.png"
  alt="Next.js + AWS"
  shadow={true}
/>
...
<Image
  source="buildingANextjsServerlessStaticSiteUsingAwsCdk/highLevelSolutionArchitecture2.png"
