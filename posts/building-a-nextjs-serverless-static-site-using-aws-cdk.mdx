...
Our infrastructure resources will be contained within a [CloudFromation Stack](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacks.html). This allows us to manage this set of resources as a single unit, making creating, updating and deleting our resources much more straightforward.
