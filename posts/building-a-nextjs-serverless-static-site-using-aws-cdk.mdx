...
All of the code for this can be found on my [GitHub](https://github.com/tylangesmith-organisation/nextjs-serverless-static-site)!
...
It's also worth mentioning that hosting solutions like [Vercel](https://vercel.com/) make deploying a Next.js project ridiculously easy (plus a bunch of other frameworks), not to mention all of the optimisations that it provides right out of the box. From a developer experience perspective, this is amazing and well worth consideration. I'll probably be moving this deployment to Vercel soon.
