...
Next, we need to create an S3 Static Website Bucket. We can create a simple helper function in our stack to abstract this. We'll also need to define a simple function that generates the URL for our branch. We can then use this URL as our bucket name.
