...
That being said, let's break down each of our components and implement them with AWS CDK.  Again our high-level solution architecture looks like the following:
