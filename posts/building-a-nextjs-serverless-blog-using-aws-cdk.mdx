---
slug: building-a-nextjs-serverless-blog-using-aws-cdk
title: Building a Next.js Serverless Blog using AWS CDK
...
> In this section, I assume you can create a Typescript project

We're now at the point where we want to start implementing our solution. To refresh from a high level, this looks like:
...
As previously mentioned, we'll be using AWS CDK to define our AWS infrastructure. In our case, we'll be using the Typescript AWS CDK implementation.

Let's first start by installing a few required dependencies.

<Gist id="038bbcc4ab75b96d7820f5b36bbf71ae" />

This installs core AWS CDK dependencies, the required resource constructs and assertion helpers for unit testing.
