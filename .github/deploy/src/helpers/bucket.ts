...
export const createStaticWebsiteBucket = (props: CreateStaticWebsiteBucketProps) => {
...
export const createStaticWebsiteBucketDeployment = (props: CreateStaticWebsiteBucketDeploymentProps) => {
